...
import MedicaVencimiento from "./medicaVencimiento/medicaVencimiento.jsx";
          ...
          <div className="search-container">
            ...
            <div>
              ...
              >
                ...
                <option value="recient">Agregado recientemente</option>
              </select>
            </div>
          </div>
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="input-group mb-3">
                            ...
                            >
                              ...
                              <option value="1">LabGen</option>
                              <option value="2">BioPharm</option>
                              <option value="3">MediLab</option>
                              <option value="4">PharmaTech</option>
                              <option value="5">HealthLab</option>
                            </select>
                          </div>
                          <small className="form-text text-muted mb-2">
                            IVA
