...
import { Container, Row, Col, Card, Form, Alert, Tabs, Tab } from "react-bootstrap";
import { MyDocument } from "../../../Report/MyDocument.jsx";
import { MyDocumentMovimientos } from "../../../Report/MyDocument.Mov.jsx";
import { MyDocumentProv } from "../../../Report/MyDocumentProv.jsx";
        ...
        <div className="mainContainer_inform">
          <div className="profile-section">
            <h2 className="informe-title">Informes</h2>
                ...
                <Tabs defaultActiveKey="productos" id="informes-tabs" className="mb-3">
                        ...
                        <Col md={8}>
                          <Form.Group controlId="formProductReportType">
                            ...
                            <Form.Control
                              ...
                              onChange={(e) => setProductReportType(e.target.value)}
                              className="mb-3"
                            >
                              <option value="todos">Todos los Productos</option>
                              <option value="vencer">Productos por Vencer</option>
                              <option value="stock">Productos en Stock</option>
                              <option value="fecha-ingreso">Productos por Fecha de Ingreso</option>
                            </Form.Control>
                          </Form.Group>
                        </Col>
                      </Row>
                      ...
                      {productReportType === "fecha-ingreso" && (
                        <Row className="mb-3 justify-content-center">
                          <Col md={4}>
                            <Form.Group controlId="formProductFechaInicio">
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => setProductFechaInicio(e.target.value)}
                              />
                            </Form.Group>
                          </Col>
                          <Col md={4}>
                            <Form.Group controlId="formProductFechaFin">
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => setProductFechaFin(e.target.value)}
                              />
                            </Form.Group>
                          </Col>
                          <Col md={8} className="mt-3">
                            {productFechaInicio &&
                              productFechaFin &&
                              new Date(productFechaInicio) > new Date(productFechaFin) && (
                        ...
                        <Col md={8}>
                          <Form.Group controlId="formMovementReportType">
                            ...
                            <Form.Control
                              ...
                              onChange={(e) => setMovementReportType(e.target.value)}
                              className="mb-3"
                            >
                              <option value="todos">Todos los Movimientos</option>
                              <option value="fechas">Movimientos por Fecha</option>
                              <option value="porproducto">Movimientos por Producto</option>
                              <option value="usuario">Movimientos por Usuario</option>
                          ...
                          <Col md={4}>
                            <Form.Group controlId="formMovementFechaInicio">
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => setMovementFechaInicio(e.target.value)}
                              />
                            </Form.Group>
                          </Col>
                          <Col md={4}>
                            <Form.Group controlId="formMovementFechaFin">
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => setMovementFechaFin(e.target.value)}
                              />
                            </Form.Group>
                          </Col>
                          <Col md={8} className="mt-3">
                            {movementFechaInicio &&
                              movementFechaFin &&
                              new Date(movementFechaInicio) > new Date(movementFechaFin) && (
                                <Alert variant="warning" className="mb-0 w-100">
                                  La fecha de inicio es mayor que la fecha final
                                </Alert>
                              )}
                        ...
                        <Col md={8}>
                          <Form.Group controlId="formProviderReportType">
                            ...
                            <Form.Control
                              ...
                              onChange={(e) => setProviderReportType(e.target.value)}
                              className="mb-3"
                            >
                              <option value="laboratorios">Todos los Laboratorios</option>
                              <option value="laboratorio">Informe de Laboratorio</option>
                              <option value="productos">Productos por Laboratorio</option>
                            </Form.Control>
                          </Form.Group>
                        </Col>
                      </Row>

                      {(providerReportType === "laboratorio" || providerReportType === "productos") && (
                        <Row className="mb-3 justify-content-center">
                          <Col md={8}>
