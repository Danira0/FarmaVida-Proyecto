...
export const registerUser = async (userData) => {
 ...
 <a href="http://172.210.66.28:4000/api/auth/approve?correo=${correo}&nombre=${nombre}&apellido=${apellido}&nombre_usuario=${nombre_usuario}&ROLID_ROL=${ROLID_ROL}&contrasena_usuario=${contrasena_usuario}" style="margin-right: 10px; text-decoration: none; padding: 10px 20px; background-color: #4CAF50; color: white; border-radius: 5px;">Aprobar</a>
<a href="http://172.210.66.28:4000/api/auth/deny?correo=${correo}" style="text-decoration: none; padding: 10px 20px; background-color: #f44336; color: white; border-radius: 5px;">Denegar</a>
        </div>
      </div>
    `,
  };
