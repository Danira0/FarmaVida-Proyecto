...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:4000/api/register", datosRegistro);
  ...
  const checkApproval = async () => {
    try {
      const response = await axios.get(`http://localhost:4000/api/checkApproval?correo=${correoGuardado}`);
