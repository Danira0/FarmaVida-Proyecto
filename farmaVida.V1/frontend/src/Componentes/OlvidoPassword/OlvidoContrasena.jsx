...
function OlvidoContrasena() {
  ...
  const handleSolicitudRecuperacion = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:4000/api/olvidar-contrasena", {
        correo: email
      });
  ...
  const handleVerificarCodigo = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:4000/api/establecer-codigo-verificacion", {
        token,
        code: codigo
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      await axios.post("http://localhost:4000/api/establecer-contrasena", {
        token,
