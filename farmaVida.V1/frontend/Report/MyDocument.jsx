  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        switch (reportType) {
          case "todos":
            endpoint = "http://localhost:4000/api/productos/todos";
            break;
          case "vencer":
            endpoint = "http://localhost:4000/api/productos/vencer";
            break;
          case "stock":
            endpoint = "http://localhost:4000/api/productos/stock";
            break;
          case "fecha-ingreso":
            endpoint = `http://localhost:4000/api/productos/fecha-ingreso?fechaInicio=${fechaInicio || ""}&fechaFin=${fechaFin || ""}`;
            break;
          default:
            endpoint = "http://localhost:4000/api/productos/todos";
        }
