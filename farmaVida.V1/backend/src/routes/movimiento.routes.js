...
import { getMovimiento, createMovimiento, updateMovimiento, deleteMovimiento, getMovimientoById, getTodosMovimientos, getMovimientoPorFecha, getMovimientoPorProducto,  getMovimientoPorUsuario, getMovimientoPorTipo, getDevolucionesPendientes, createDevolucion} from '../controllers/movimiento.controller.js';
...
router.get('/devoluciones-pendientes/:movimientoId', getDevolucionesPendientes);
