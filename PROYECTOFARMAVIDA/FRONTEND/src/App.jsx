...
import Salidas from "./Componentes/inventario/Movimiento/filtroMovimiento/Salidas.jsx";4
...
function AppWrapper() {
  ...
  useEffect(() => {
    const handleBackButton = (event) => {
      if (
        location.pathname === "/homeadmi" ||
        location.pathname === "/homeemple"
      ) {
        ...
        <Route
          ...
          element={
            user?.rolId === 1 ? (
              ...
              <Navigate to={user?.rolId === 2 ? "/homeemple" : "/"} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            user?.rolId === 2 ? (
              ...
              <Navigate to={user?.rolId === 1 ? "/homeadmi" : "/"} />
            )
          }
        />
