...
export const MovementsByProductReport = ({ data, productoId, subtitle }) => {
  const productName = data[0]?.nombre_producto || 'Producto no especificado';
...
export const MovementsByUserReport = ({ data, usuarioId, subtitle }) => {
  const userName = data[0]?.nombre_completo_usuario || data[0]?.nombre_usuario || 'Usuario no especificado';
